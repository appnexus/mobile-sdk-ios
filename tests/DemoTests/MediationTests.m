	...
	if (!__testComplete)
	{
		switch (__testNumber)
		{
			case 1:
			{
				...
				id adapter = [[fetcher mediationController] currentAdapter];
				STAssertTrue([adapter isKindOfClass:[ANAdAdapterBanneriAd class]], @"Expected an adapter of type ANAdAdapterBanneriAd.");
			}
				break;
			...
			case 7:
			{
				...
				id adapter = [[fetcher mediationController] currentAdapter];
				STAssertTrue([adapter isKindOfClass:[ANAdAdapterBannerMillennialMedia class]], @"Expected an adapter of type ANAdAdapterBannerMillennialMedia.");
			...
			case 11:
			{
				...
				id adapter = [[fetcher mediationController] currentAdapter];
				STAssertTrue([adapter isKindOfClass:[ANAdAdapterBannerMillennialMedia class]],
                             @"Expected an adapter of type ANAdAdapterBannerMillennialMedia.");
			}
				break;
			case 12:
			{
