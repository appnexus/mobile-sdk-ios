...
@interface BannerAdViewabilityTrackerTestVC : XCTestCase
...
*/
-(void)testBannerOMIDEventSupportedIsYes{
 ...
 */
-(void)testBannerOMIDEventSessionStart{
    XCUIApplication *app = [[XCUIApplication alloc] init];
    app.launchArguments = [app.launchArguments arrayByAddingObject:BannerViewabilityTrackerTest];
 ...
 */
- (void)testBannerOMIDEventViewable100Percentage {
 ...
 */
- (void)testBannerOMIDVersionEvent {
    // Use recording to get started writing UI tests.
    // Use XCTAssert and related functions to verify your tests produce the correct results.
    XCUIApplication *app = [[XCUIApplication alloc] init];
    app.launchArguments = [app.launchArguments arrayByAddingObject:BannerViewabilityTrackerTest];
...
/*
 testBannerOMIDEventViewable0Percentage: To test the OMID is 0% Viewable
 */
- (void)testBannerOMIDEventViewable0Percentage {
    // Use recording to get started writing UI tests.
    // Use XCTAssert and related functions to verify your tests produce the correct results.
    XCUIApplication *app = [[XCUIApplication alloc] init];
    app.launchArguments = [app.launchArguments arrayByAddingObject:BannerViewabilityTrackerTest];
 ...
 */
- (void)testBannerOMIDTypeImpression {
    // Use recording to get started writing UI tests.
    // Use XCTAssert and related functions to verify your tests produce the correct results.
    XCUIApplication *app = [[XCUIApplication alloc] init];
    app.launchArguments = [app.launchArguments arrayByAddingObject:BannerViewabilityTrackerTest];
