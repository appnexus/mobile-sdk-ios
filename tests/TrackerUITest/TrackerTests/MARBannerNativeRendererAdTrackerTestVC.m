...
#import "Constant.h"
@interface MARBannerNativeRendererAdTrackerTestVC : XCTestCase
...
/*
 testMARBannerNativeImpressionTrackerTestAd: To test the impression tracker is fired by the MAR BannerNativeRenderer Ad.
 */
- (void)testMARBannerNativeImpressionTrackerTestAd {
    XCUIApplication *app = [[XCUIApplication alloc] init];
    app.launchArguments = [app.launchArguments arrayByAddingObject:MARBannerNativeRendererImpressionClickTrackerTest];
    [app launch];
...
/*
 testMARBannerNativeClickTrackerTestAd: To test the click tracker is fired by the MAR BannerNativeRenderer Ad.
 */
- (void)testMARBannerNativeRendererClickTrackerTestAd {
//
//    XCUIApplication *app = [[XCUIApplication alloc] init];
//    app.launchArguments = [app.launchArguments arrayByAddingObject:MARBannerNativeRendererImpressionClickTrackerTest];
//    [app launch];
//
//
//    XCUIElement *bannerad = app.staticTexts[@"This is a test creative"];
//    [self waitForElementToAppear:bannerad  withTimeout:8];;
//    [bannerad tap];
//
////    XCUIElement *clickTracker = app.staticTexts[@"ClickTracker"];
////    [self waitForElementToAppear:clickTracker  withTimeout:8];;
//    XCUIElement *impressionTracker = app.staticTexts[@"ImpressionTracker"];
//    [self waitForElementToAppear:impressionTracker  withTimeout:8];;
//    XCTAssertTrue(impressionTracker.exists);
