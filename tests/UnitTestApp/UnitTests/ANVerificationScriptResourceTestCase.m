...
- (void)testRTBNativeResponseForViewabilityObject
{
    ...
    XCTAssertEqualObjects(nativeAd.verificationScriptResource.url, @"http://cdn.adnxs.com/v/s/160/trk.js");
...
- (void)testCSMNativeResponseForViewabilityObject
{
    ...
    XCTAssertEqualObjects(mediatedAd.verificationScriptResource.url, @"http://cdn.adnxs.com/v/s/160/trk.js");
