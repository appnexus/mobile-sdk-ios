...
@implementation ANAdAdapterNativeMock
...
- (void)requestNativeAdWithServerParameter:(nullable NSString *)parameterString
    ...
    ANNativeMediatedAdResponse *response = [[ANNativeMediatedAdResponse alloc] initWithCustomAdapter:self networkCode:ANNativeAdNetworkCodeAdMob];
