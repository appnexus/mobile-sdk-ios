 ...
 * @param impressionTracker a custom HTML/Javascript for the publisher to track impressions if he chooses to.
 */
 ...
 * @param impressionTracker a custom URL for the publisher to track impressions if he chooses to.
 */
 ...
 * @param clickTracker A custom HTML/Javascript that the publisher provides to track clicks if he chooses to.
 */
-(void)reportAdClick:(NSDictionary*)extras withCustomClickTrackerScript:(NSString*)clickTracker;
/**
 * Reports that a click has happened on the native ad.
 * @param extras Any additional params that the publisher would like to report.
 * @param clickTracker A custom URL that the publisher provides to track clicks if he chooses to.
 */
 ...
 * @param extras Any additional params that the publisher would like to report.
 * @param script A custom HTML/Javascript that the publiser can provide to track clicks if he chooses to.
 */
