 ...
 */
@interface OMIDMicrosoftAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDMicrosoftPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDMicrosoftPartner *)partner
                               ...
                               resources:(NSArray<OMIDMicrosoftVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
