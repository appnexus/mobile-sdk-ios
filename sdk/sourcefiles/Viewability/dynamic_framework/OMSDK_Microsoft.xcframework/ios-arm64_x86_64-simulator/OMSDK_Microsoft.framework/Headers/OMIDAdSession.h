 ...
 */
@interface OMIDMicrosoftAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDMicrosoftAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDMicrosoftAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDMicrosoftAdSessionContext *)context
