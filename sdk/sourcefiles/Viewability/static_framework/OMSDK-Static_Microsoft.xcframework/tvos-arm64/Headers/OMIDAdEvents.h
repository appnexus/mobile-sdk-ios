 ...
 */
@interface OMIDMicrosoftAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDMicrosoftAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDMicrosoftVASTProperties *_Nonnull)vastProperties
